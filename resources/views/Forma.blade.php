...
<div class="row justify-content-md-center">
  <h1 class="h3 mb-3 font-weight-normal mt-3">Пожалуйста заполните форму</h1>
  <div class="col col-lg">
   
  </div>
    <div class="col" >
        <body class="text-center">
            <form class="form-signin"  action="{{ route('forma-form')}}" method="post">
                @csrf
                 ...
                 <input type="email" id="email" name="email" class="form-control mt-2" placeholder="Email" required="" autofocus="">
                 ...
                 <input type="text" id="Adres" name="Adres" class="form-control mt-2" placeholder="Адрес" required="" autofocus="">
                 ...
                 <script>
                     $("#Adres").suggestions({
                         token: "0be74e0515d576c8cdc6f05f56029cbdd6bbd179",
                         type: "ADDRESS",
